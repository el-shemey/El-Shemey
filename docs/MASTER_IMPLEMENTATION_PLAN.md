...
## Status: PHASE 0 COMPLETE (pending owner review)
...
**PHASE 1, Step 1:** Bootstrap repository (Next.js + TS strict + Tailwind + ESLint/Prettier/Vitest/Playwright CI), then produce design-language exploration: tokens, type specimens (Arabic-first), and 2–3 art-directed component studies (hero fragment, course card, pricing block) for visual review against the anti-AI-template contract — BEFORE building any full pages.
